...
const MachineDetail = ({ user }) => {
    ...
    const getDisplayData = (dataType = 'monitoring') => {
     ...
     const autoSelectDefaultShift = (shifts) => {
        ...
        // ✅ Nếu không có ca active, chọn ca mới nhất (đầu tiên trong list đã sort)
        const latestShift = shifts[0]; // shifts đã được sort từ backend: ca mới nhất ở đầu
