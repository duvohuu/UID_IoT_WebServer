...
const MachineDetail = ({ user }) => {
    ...
    // Format với 2 số thập phân, không dùng toLocaleString
                        ...
                        <Box sx={{ mb: 3, p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                                    ...
                                    <Typography variant="body2" sx={{ fontWeight: 500 }}>
                                        {(displayData.shiftInfo.totalWeightFilled || 0).toLocaleString('vi-VN')} Kg
                                    </Typography>
                                </Grid>
                                <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                                    <Typography variant="caption" color="text.secondary">Hiệu suất ca làm việc</Typography>
                                    <Typography variant="body2" sx={{ fontWeight: 500 }}>
                                        {formatEfficiency(displayData.shiftInfo.efficiency)}
                                    </Typography>
                                    {/* ✅ THÊM debug info */}
                                    <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.7rem' }}>
                                        Raw: {displayData.shiftInfo.efficiency} | 
                                        Weight: {displayData.shiftInfo.totalWeightFilled}g | 
                                        Duration: {displayData.shiftInfo.duration}min
                                    </Typography>
                                </Grid>
                            </Grid>
                        </Box>
