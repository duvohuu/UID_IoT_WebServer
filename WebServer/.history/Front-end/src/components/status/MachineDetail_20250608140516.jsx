...
const MachineDetail = ({ user }) => {
        ...
        const fetchMachine = async () => {
            try {
                ...
                if (result.success) {
                    ...
                    // ✅ SỬA: LUÔN lấy work shifts (không phụ thuộc vào isConnected)
    ...
    useEffect(() => {
        if (machine?._id) {
            // Fetch ngay khi có machine._id
            fetchWorkShifts(machine._id);
            
            // ✅ THÊM: Auto refresh mỗi 10 giây (chỉ khi máy online)
            let interval;
    ...
    }, [machine?._id, machine?.isConnected]);
